...
$.each(rotas, function (key, val) {
    $("#voos").append("<tr><td>" + val['callsign'] + "</td><td>" + val['rota'] + "</td><td>" + val['fl'] + "</td><td>" + val['std'] + "Z</td><td>" + val['aeronave'] + "</td><td>" + val['eet'] + "</td><td><a data-toggle='modal' href='#modal" + val['callsign'] + "'>Ver Briefing</a> | <a class='blue-text text-darken-4' href='fpl.php?id=" + val['id'] + "'>IVAO FPL</a></td></tr>")
