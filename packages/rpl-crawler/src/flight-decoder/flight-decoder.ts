...
const makeFlightDecoder = () => {
    return (line: string): Flight => {
        ...
        const endDate = endDatePlainText !== 'UFN' ? resolveFlightDate(endDatePlainText) : null
        ...
        return {
            ...
            estimatedEnrouteMinutes: resolveEstimatedEnrouteMinutes(line.substr(line.indexOf('EQPT') - 5, 4).trim()),
