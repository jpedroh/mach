...
export const Head = twc.thead<ComponentProps<'thead'>>`bg-blue-700 text-white uppercase`

export const Heading = twc.th<ComponentProps<'th'>>`font-semibold p-2`

export const Body = twc.tbody<ComponentProps<'tbody'>>`bg-gray-300/10 dark:text-white uppercase`
