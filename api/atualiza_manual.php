...
class RPLatualiza{
    ...
    public function baixar($fir){
        $url = 'http://portal.cgna.gov.br/files/abas/2017-09-04/painel_rpl/bdr/RPL' . $fir .'.zip';
        ...
        if ($httpcdd != '404'){
            ...
            file_put_contents('rpl/' . $fir .'.zip', file_get_contents('http://portal.cgna.gov.br/files/abas/2017-09-04/painel_rpl/bdr/RPL' . $fir .'.zip'));
...
public function salvar(){
        ...
        foreach($lista as $aeronave){
            if(strpos($aeronave, 'EQPT')){
                ...
                $this->dias = substr($aeronave, 17, 8);
                ...
                $this->identificador = $this->callsign . $this->partida . $this->chegada . $this->std;
                $query = "INSERT INTO rpl VALUES ('$this->id', '$this->callsign', '$this->cia', '$this->voo', '$this->aeronave', '$this->esteira', '$this->partida', '$this->std', '$this->velocidade', '$this->fl', '$this->rota', '$this->chegada', '$this->eet', '$this->rmk', '$this->eqpt', '$this->identificador', '$this->dias')";
